...
<div class="card uper">
    <div class="card-header">
        Upload data Tingkat <?= $tingkat ?> No Dokumen <?= $no_dokumen ?> analisis kebijakan
    ...
    <div class="card-body">
        ...
        @endif
        <form method="post" action="{{route('analisis-kebijakan')}}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input type="file" class="form-control" id="datatiga" multiple name="file4" />
            </div>
