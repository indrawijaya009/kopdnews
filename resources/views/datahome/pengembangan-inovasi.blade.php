            ...
            <div>
                <div class="row">
                    ...
                    @for ($i = 1; $i < 6; $i++) <div class="col-sm-4">
                        ...
                        <div class="card">
                            <a href="{{url('/pengembangan-inovasi/'.$i)}}" style="margin:10px;">Pengukuran Kinerja
                                Tingkat
                                <?= $i ?></a>
                            <div class="container">
                                <h4><b><a href="{{url('/pengembangan-inovasi/'.$i)}}" style="margin:10px;">Pengukuran
                                            Kinerja Tingkat <?= $i ?></a></b></h4>
                            </div>
                        </div>
                </div>
                @endfor
