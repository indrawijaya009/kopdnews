        ...
        <div class="col-md-12">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="container">
                                <h4><b><a href="/rancangan-pembangunan" style="margin:10px;">Rancangan
                                            pembangunan</a></b></h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="container">
                                <h4><b><a href="/standar-operasional" style="margin:10px;">Standar Operasional</a></b>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="container">
                                <h4><b><a href="/pendidikan-pelatihan" style="margin:10px;">Pendidikan dan
                                            Pelatihan</a></b></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="container">
                                <h4><b><a href="/analisis-kebijakan" style="margin:10px;">Analisis Kebijakan</a></b>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="card">
                            ...
                            <div class="container">
                                <h4><b><a href="/pengukuran-kinerja" style="margin:10px;">Pengukuran Kinerja</a></b>
                                </h4>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <a href="/pengembangan-inovasi" style="margin:10px;">pengembangan-inovasi</a>
                            <div class="container">
                                <h4><b><a href="/pengembangan-inovasi" style="margin:10px;">pengembangan-inovasi</a></b>
                                </h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            <a href="/budaya-organisasi" style="margin:10px;">budaya-organisasi</a>
                            <div class="container">
                                <h4><b><a href="/budaya-organisasi" style="margin:10px;">budaya-organisasi</a></b></h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="card">
                            <a href="/pengendalian-pelaksana" style="margin:10px;">pengendalian-pelaksana</a>
                            <div class="container">
                                <h4><b><a href="/pengendalian-pelaksana"
                                            style="margin:10px;">pengendalian-pelaksana</a></b>
                                </h4>
                            </div>
                        </div>
                    </div>
