...
<div class="card uper">
    <div class="card-header">
        Upload data Tingkat <?= $tingkat ?> No Dokumen <?= $no_dokumen ?> pengendalian pelaksana
        <!-- <a href="/downloadFile">
    ...
    <div class="card-body">
        ...
        @endif
        <form method="post" action="{{route('pengendalian-pelaksana')}}" enctype="multipart/form-data">
            @csrf
