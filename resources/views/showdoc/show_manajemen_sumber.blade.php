...
<div class="card uper">
    <div class="card-body">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">Show Data Manajemen Sumber</div>
            </div>
            </br>
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($manajemen_sumber as $file1)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file1->id }}</th>
                            <td>{{ $file1->file1 }}</td>
                            <td> <a href="{{asset('storage/manajemen_sumber/'.$file1['file1'])}}" target="_blank"
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($manajemen_sumber as $file2)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file2->id }}</th>
                            <td>{{ $file2->file2 }}</td>
                            <td> <a href="{{asset('storage/manajemen_sumber/'.$file2['file2'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($manajemen_sumber as $file3)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file3->id }}</th>
                            <td>{{ $file3->file3 }}</td>
                            <td> <a href="{{asset('storage/manajemen_sumber/'.$file3['file3'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($manajemen_sumber as $file4)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file4->id }}</th>
                            <td>{{ $file4->file4 }}</td>
                            <td> <a href="{{asset('storage/manajemen_sumber/'.$file4['file4'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
