...
<div class="card uper">
    <div class="card-body">
        <div class="col-md-12">
            ...
            <div class="container">
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rancangan_pembangunan as $file1)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file1->id }}</th>
                            <td>{{ $file1->file1 }}</td>
                            <td> <a href="{{asset('storage/rancangan_pembangunan/'.$file1['file1'])}}" target="_blank"
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rancangan_pembangunan as $file2)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file2->id }}</th>
                            <td>{{ $file2->file2 }}</td>
                            <td> <a href="{{asset('storage/rancangan_pembangunan/'.$file2['file2'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rancangan_pembangunan as $file3)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file3->id }}</th>
                            <td>{{ $file3->file3 }}</td>
                            <td> <a href="{{asset('storage/rancangan_pembangunan/'.$file3['file3'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
                ...
                <table class="table table-bordered">
                    ...
                    @foreach ($rancangan_pembangunan as $file4)
                    <tbody>
                        <tr>
                            <th scope="row">{{ $file4->id }}</th>
                            <td>{{ $file4->file4 }}</td>
                            <td> <a href="{{asset('storage/rancangan_pembangunan/'.$file4['file4'])}}" target="_blank"
                                    class="btn btn-primary">Download</a></td>
                        </tr>
                    </tbody>
                    @endforeach
        ...
        <!-- 
                            <ul>
                                <li> <a href="/rancangan_pembangunan">kuisoner</a></li>
